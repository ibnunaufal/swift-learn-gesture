...
struct HomeView: View {
    ...
    var body: some View{
        VStack(spacing: 20) {
            ...
            Text("The time that leads to mastery is dependent on the intensity of focus").font(.title3).fontWeight(.light).foregroundColor(.secondary).multilineTextAlignment(.center).padding()
